...
def evaluate_chat_with_docs(query):
    response = chat_with_docs(messages=[{"role": "user", "content": query}])
...
if __name__ == "__main__":
    ...
    result = evaluate(
        ...
        target=evaluate_chat_with_docs,
        evaluation_name="evaluate_chat_with_docs",
        evaluators={
